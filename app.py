...
ВСЁ ИЛЛЮСТРАТИВНО: спрос — прокси на электроданных; давление и экономика — по
упрощённым моделям с условными параметрами (см. константы ниже). Замени их на
реальные значения из ВКР.
...
# --- допущения для экономики (ЗАМЕНИ на свои из ВКР) ---
...
st.caption(f"Допущения (замени на свои из ВКР): утечка {LEAK_AT_PMAX_M3_PER_H:.0f} м³/ч при {P_MAX} МПа, "
